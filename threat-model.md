...
| --- | --- | --- |
| AS-0001 | reliability of system data | [**T-0002**](#T-0002): A system user with access to multiple environments can execute with incorrect credentials, which leads to unintended table updates, negatively impacting reliability of system data<br/>[**T-0003**](#T-0003): A malicious actor who can add new questions to the prompts can inject a prompt attach, which leads to unintended outputs, negatively impacting reliability of system data |
