...
| <a name="A-0004"></a>A-0004 | Access to add or update questions is limited to resources with a business need | [**T-0003**](#T-0003): A malicious actor who can add new questions to the prompts can inject a prompt attack, which leads to unintended outputs, negatively impacting reliability of system data |  |  |
